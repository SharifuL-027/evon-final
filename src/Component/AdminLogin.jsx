...
const AdminLogin = () => {
  ...
  return (
    // Updated to bg-slate-50 to match the light, premium theme of EVON
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={loading}
                type="button"
                className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-bold text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors disabled:opacity-50"
              >
